...
for NOFMODELS = 1:2
    ...
    % NOFDAYS = 5; % Reduce dataset by half
    ...
    for idx_itr = 0 : max_itr % 10 * NOFDAYS
        ...
        err = 1e-3;
        if idx_itr > data_set.NOFTRAIN && mean(abs(result_J_theta(end - data_set.NOFTRAIN + 1 : end))) < err
            break;
        end
    end
    ...
    save("results/data_td_" + NOFMODELS + "EVs_" + TimeLimit + ".mat", "param_td");
